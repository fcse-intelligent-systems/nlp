import numpy as np
from script.word_embeddings import load_embedding_weights
from tensorflow.keras.preprocessing.sequence import pad_sequences
from sklearn.model_selection import train_test_split
from av5.non_sarcastic_rephrase_train import load_data, tokenize, append_start_end, \
    create_vocabulary, create_model
from script.nlg_evaluation import score_predictions
